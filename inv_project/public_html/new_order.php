				  ...
				  <div class="card-body">
				  	<form id="get_order_data" onsubmit="return false">
				  		<div class="form-group row">
				  			...
				  			<div class="col-sm-6">
				  				<input type="text" id="order_date" name="order_date" readonly class="form-control form-control-sm" value="<?php date_default_timezone_set('Asia/Kolkata'); echo date("Y-m-d"); ?>">
				  			</div>
				  		</div>
				  		<div class="form-group row">
		...
		<!--<tr>
		    ...
		    <td>Rs.1540</td>
		                        ...
		                        <center style="padding:10px;">
		                        	...
		                        	<button id="remove" style="width:150px;" class="btn btn-danger"><i class="fa fa-close">&nbsp;</i>Remove</button>
		                        </center>
				  			</div> <!--Crad Body Ends-->
